    ...
    <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-gray-100">
            {contacts.map((contact) => {
              const initials =
                `${(contact.firstName || "U")[0]}${(contact.lastName || "N")[0]}`.toUpperCase();
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-4">
                    <Link to={`/dashboard/contacts/${contact.id}`} className="flex items-center space-x-3 group">
                  ...
                  <td className="px-4 py-4">
                    <span
                      className={`inline-flex items-center space-x-1.5 px-2.5 py-1 rounded-full text-xs font-medium ${getStatusStyle(
                        contact.status
                      )}`}
                    >
      ...
      {contacts.length === 0 && (
        <div className="py-16 text-center">
          ...
          <p className="text-gray-500 mb-6">Try changing your search or import contacts.</p>
        </div>
      )}
    </div>
  );
