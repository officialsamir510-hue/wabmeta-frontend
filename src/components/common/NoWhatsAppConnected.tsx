...
import { MessageSquare, Settings, ExternalLink, AlertCircle } from 'lucide-react';
...
const NoWhatsAppConnected: React.FC<NoWhatsAppConnectedProps> = ({
  title = 'No WhatsApp Account Connected',
  description = 'Connect your WhatsApp Business account to access this feature.',
  showIcon = true,
  variant = 'full-page',
  actionLabel = 'Connect WhatsApp Account',
  actionUrl = '/settings?tab=api',
}) => {
  // Full page variant
